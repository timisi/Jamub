      ...
      // }
              ...
              if (filter_var($staffEmailId, FILTER_VALIDATE_EMAIL)) {
                  ...
                  for($i=1;$i<=$tot;$i++) {
                      ...
                      $sql="INSERT INTO tblleave (TaskDone, ExpectedNumberofTask, TotalTaskAchieved, EvaluationType,ReviewPeriod,DateofLastReview,Sign,Challenges,HodRemarks,RegRemarks,IsRead,empid,PostingDate,taskpercentage)	VALUES ('$a1','$a2','$a3','$evaluation_type','$review_period','$last_review', '$signature','$taskchallenges','$hod_status','$reg_status','$isread','$empid', '$datePosting','$percentage')";
