		...
		<div class="pd-ltr-20">
				...
				<div class="row align-items-center">
					...
					<?php $query= mysqli_query($conn,"select * from tblemployees where emp_id = '$session_id'")or die(mysqli_error());
						...
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back <div class="weight-600 font-30 text-blue"><?php echo $row['FirstName']. " " .$row['LastName']; ?>, <?php echo $row['Position_Staff']; ?></div>
						</h4>
						<p class="font-18 max-width-600"><br>
							<strong>RESPONSIBILITIES:</strong>
							<br>Your roles and responsibilities in this position include the following:<br>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								...
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLongTitle">Responsibilities</h5>
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Approved Appraisal</div>
							</div>
							<div class="widget-icon">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Pending Appraisal</div>
							</div>
							<div class="widget-icon">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($leavecount); ?></div>
								<div class="font-14 text-secondary weight-500">Rejected Appraisal</div>
							</div>
							<div class="widget-icon">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Partners</div>
							<div class="table-actions">
								<a title="VIEW" href="staff.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">LATEST APPRAISAL APPLICATIONS</h2>
					</div>
				<div class="pb-20">
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											...
											<a class="dropdown-item" href="index.php?leaveid=<?php echo htmlentities($result->lid);?>"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
							</tr>
