...
<?php
	...
	{ 
		...
		if ($status === '2') {
			$result = mysqli_query($conn,"update tblleave, tblemployees set tblleave.RegRemarks='$status',tblleave.RegSign='$signature',tblleave.RegDate='$admremarkdate',tblleave.total_overall_score='$grandtotal',tblleave.hrmapprovalcomment='$hrmapprovalcomment' where id='$did'");
