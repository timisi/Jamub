		...
		<div class="pd-ltr-20">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Staff Members</div>
						</div>
						 <div class="user-list">
							<ul>
								<?php
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Chat with a team</div>
						</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h2 class="text-blue h4">APPRAISAL HISTORY</h2>
				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus">APPRAISAL TYPE</th>
								<th>REVIEW PERIOD</th>
						...
						<tbody>
							<tr>
								...
								?>  
                                  ...
                                  <td><?php echo htmlentities($result->ReviewPeriod);?></td>
                                  <td><?php echo htmlentities($result->DateofLastReview);?></td>
