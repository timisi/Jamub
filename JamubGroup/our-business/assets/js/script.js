...
$(document).ready(function() {
	$(window).scroll(function() {
      ...
      $('.unseriousone').css("color" , "#100d5c");
      $('.home-logo').attr('src','../../wp-content/themes/dangote/assets/img/jamublogo2color.png');
      $('.home-logotwo').attr('src','../../wp-content/themes/dangote/assets/img/jamublogo2color.png');
	  }
	});
});
