            ...
            <div class="top-footer-section @if ($bs->copyright_section == 0) border-bottom-0 @endif">
               <div class="row">
                  <div class="col-lg-4 col-md-12">
                     ...
                     <p align="justify" class="footer-txt">
                  ...
                  <div class="col-lg-3 col-md-4">
                     ...
                     <form class="footer-newsletter" id="footerSubscribeForm" action="{{route('front.subscribe')}}" method="post">
                       @csrf
                       <p align="justify">{{convertUtf8($bs->newsletter_text)}}</p>
                  ...
                  <div class="col-lg-3 col-md-5">
                     ...
                     <div class="footer-contact-info">
                        <ul>
                           ...
                           <li><i class="far fa-envelope"></i><span>{{convertUtf8($bs->support_email)}}</span></li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                if ((data.errors)) {
                  ...
                  toastr["success"]("Thank You, Email Subscription Successfully!");
                  $this.trigger('reset');
