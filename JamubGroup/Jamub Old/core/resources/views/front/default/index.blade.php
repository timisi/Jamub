...
@section('content')
     ...
     <div class="container">
       ...
       <div class="row">
          <div class="col-lg-6 {{$rtl == 1 ? 'pl-lg-0' : 'pr-lg-0'}}">
             <div class="intro-txt">
                <span class="section-title">{{convertUtf8($bs->intro_section_title)}}</span><br><br>
                <p align="justify">{{convertUtf8($bs->intro_section_text)}} </p><br>
        ...
        <section class="services-area pb-130">
            <div class="container">
                ...
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <h5 class="section-summary">{{convertUtf8($bs->service_section_subtitle)}}</h5>
                </div>
                </div>
            </div>
            <div class="container">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item mt-30">
                                <div class="services-thumb">
                                    <img src="{{asset('assets/front/img/services/' . $service->main_image)}}" alt="service" width="150" height="70"/>
                                </div>
                                <div class="services-content">
                                    ...
                                    <p>
                                        @if (strlen(convertUtf8($service->summary)) > 70)
                                           {{substr(convertUtf8($service->summary), 0, 70)}}<span style="display: none;">{{substr(convertUtf8($service->summary), 70)}}</span>
                            ...
                            <div class="single-category">
                                @if (!empty($scategory->image))
                                    <div class="img-wrapper">
                                        <img src="{{asset('assets/front/img/service_category_icons/'.$scategory->image)}}" alt="" width="150" height="70">
                                    </div>
                                @endif
                                <div class="text">
                                    <h4>{{convertUtf8($scategory->name)}}</h4>
                                    <p>
                                       @if (strlen(convertUtf8($scategory->short_text)) > 50)
                                          {{substr(convertUtf8($scategory->short_text), 0, 50)}}<span style="display: none;">{{substr(convertUtf8($scategory->short_text), 50)}}</span>
                                          <a href="#" class="see-more">see more...</a>
                                       @else
                ...
                @foreach ($members as $key => $member)
                 <div class="single-team-member">
                    <div class="team-img-wrapper">
                       <img src="{{asset('assets/front/img/members/'.$member->image)}}" alt="Management Team" width="270" height="280">
           ...
           @foreach ($blogs as $key => $blog)
              <div class="single-blog">
                 <div class="blog-img-wrapper">
                    <img src="{{asset('assets/front/img/blogs/'.$blog->main_image)}}" alt="" width="250" height="200">
                 </div>
                 <div class="blog-txt">
                    @php
  ...
  <div class="row text-center">
           <div class="col-lg-6 offset-lg-3">
           <HR>
              <span class="section-title"><H2>OUR CLIENTS</H2></span>
              <HR>
           </div>
        </div>
              ...
              <div class="partner-carousel owl-carousel owl-theme common-carousel">
                 @foreach ($partners as $key => $partner)
                   <a class="single-partner-item d-block" href="{{$partner->url}}" target="_blank">
                      <div class="outer-container">
                         <div class="inner-container">
                            <img src="{{asset('assets/front/img/partners/'.$partner->image)}}" alt="" width="270" height="150">
                         </div>
                      </div>
                   </a>
                 @endforeach
