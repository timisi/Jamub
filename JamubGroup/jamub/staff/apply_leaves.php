<html>
   ...
   <?php
      ...
      $challengessolution=$_POST['dealwithit'];
              ...
              if (filter_var($staffEmailId, FILTER_VALIDATE_EMAIL)) {
                  ...
                  for($i=1;$i<=$tot;$i++) {
							if($i < $tot) {
								...
								$a1 .= $_POST['taskname'.$i] .'|';
								$a2 .= $_POST['taskexpected'.$i] .'|';
								$a3 .= $_POST['taskachieved'.$i] .'|';
                        $per_temp = (($_POST['taskachieved'.$i] / $_POST['taskexpected'.$i]) * 100);
                      ...
                      $sql="INSERT INTO tblleave (TaskDone, ExpectedNumberofTask, TotalTaskAchieved, EvaluationType,ReviewPeriod,DateofLastReview,Challenges,HodRemarks,RegRemarks,IsRead,empid,PostingDate,taskpercentage, Challenges_Solution, Challenges_Recommendation) VALUES ('$a1','$a2','$a3','$evaluation_type','$review_period','$last_review','$taskchallenges','$hod_status','$reg_status','$isread','$empid', '$datePosting','$percentage','$challengessolution', '$recommendation')";
                     ...
                     <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Appraisal Application Module <?php //echo $arraysum;?> </li>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4 col-sm-12">
                                 <div class="form-group">
                                    ...
                                    <input id="review_period" name="review_period" placeholder="E.g - October, 2022&hellip;" type="text" class="form-control" required="true" autocomplete="off" value="">
                                 </div>
                              </div>
                              <div class="col-md-4 col-sm-12">
                                 <div class="form-group">
                                 ...
                                 <div class="table-responsive">
                                    <div class="table-wrapper">
                                          ...
                                          <tbody class="" id="show_item">
                                             <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="taskname1" id="taskname" class="form-control" required="true" placeholder="Enter task here&hellip;">
                                                </td>
                                                <td>
                                                    <input type="text" name="taskexpected1" id="taskqty" class="form-control" required="true"placeholder="Enter number&hellip;" onkeyup = "if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')";>
                                                </td>
                                                <td>
                                                    <input type="text" name="taskachieved1" id="taskachieved" class="form-control" required="true" placeholder="Enter number&hellip;" onkeyup = "if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')";>
                                                </td>
                                       ...
                                       <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                            <h6 class="text-blue h6"><b>EFFORT MADE TO RESOLVE THE ISSUES HIGHLIGHTED ABOVE</b></h6>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>(How did you deal with the issues) -<i><b>Not compulsory</b></i>-</label>
                                            <textarea id="taskchallenges" name="dealwithit" type="text" class="form-control"  autocomplete="off" placeholder="Enter Solutions here&hellip;"></textarea>
                                        </div>

                                        <div class="row">
                                            <div class="col-sm-8">
                                            <h6 class="text-blue h6"><b>RECOMMENDATION</b></h6>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>(If any) -<i><b>Not compulsory</b></i>-</label>
                                            <textarea id="taskchallenges" name="recommendation" type="text" class="form-control"  autocomplete="off" placeholder="Enter recommendation here&hellip;"></textarea>
                                        </div>
                              ...
                              <div class="col-md-4 col-sm-12">
                                 <div class="form-group">
                                    ...
                                    <div class="modal-footer justify-content-center">
                                       <button class="btn btn-primary" name="apply" id="" class="apply" type="submit">Submit&nbsp;Appraisal</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
  ...
  <script type="text/javascript">
   $(document).ready(function(){
        $(".add_item_btn").click(function(e) {
		  ...
		  var ty = $('.num').val();
		  var b = 1;
		  var tm = parseInt(ty) + parseInt(b);
		  $('.num').val(tm);
          $("#show_item").prepend(`<tr class="append_item">
                                <!-- <td>1</td> -->
                                <td>
                                      <!-- <textarea class="form-control" name="taskname" id="taskname" class="form-control" placeholder="Enter task here&hellip;"></textarea> -->
                                      <input type="text" name="taskname`+tm+`" id="taskname" class="form-control" required="true" placeholder="Enter task here&hellip;">
                                </td>
                                <td>
                                      <input type="text" name="taskexpected`+tm+`" id="taskqty" class="form-control" required="true" placeholder="Enter number&hellip;" onkeyup = "if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')";>
                                </td>
                                <td>
                                      <input type="text" name="taskachieved`+tm+`" id="taskachieved" class="form-control" required="true" placeholder="Enter number&hellip;" onkeyup = "if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')";>
                                </td>
                                <td class="form-group col-md-2 ">
