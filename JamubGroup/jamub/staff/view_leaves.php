					...
					<div class="row">
                        ...
                        <hr> 
                          ...
                          <div class="row">
									...
									<?php $cnt++;} } }?>
					<!-- APPRAISAL DETAILS FOR SCORING START FROM HERE -->
					<hr>
...
<!-- PART B OF THE APPRAISAL STARTs FROM HERE -->
								<div class="card-box mb-30">
									...
									<div class="form-group">
										<textarea id="taskchallenges" name="approvaljustification" type="text" class="form-control" autocomplete="off" readonly><?php echo htmlentities($result->hrmapprovalcomment);?></textarea>
									</div>
									<hr><br>
									</div>
									</div>

						<!-- APPROVAL START FROM HERE -->
						<div class="form-group row">
							<div class="col-md-6 col-sm-12">
							    <div class="form-group">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>HRM Approval</b></label>
									<?php
									if ($result->RegSign==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA";?>">
									<?php else: ?>
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Date For HRM Action</b></label>
									<?php
									if ($result->RegDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
