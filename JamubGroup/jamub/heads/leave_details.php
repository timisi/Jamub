	...
	// <!-- FOR THE USERs DATA -->
		...
		if ($status === '2') {
			...
			if ($result) {
				...
				echo "<script>alert('APPRAISAL APPLICATION REJECTED BUT NO EMAIL SENT');</script>";
				...
				if ($result) {
					if (filter_var($hodEmail, FILTER_VALIDATE_EMAIL)){
						 if (filter_var($staffEmail, FILTER_VALIDATE_EMAIL)){
							...
							echo "<script>alert('STAFF EMAIL IS INVALID. APPRAISAL APPLICATION APPROVED, BUT NO EMAIL SENT');</script>";
							echo "<script type='text/javascript'> document.location = 'index.php'; </script>";
						 }
					
					} else {
						echo "<script>alert('YOUR EMAIL IS INVALID. APPRAISAL APPLICATION APPROVED, BUT NO EMAIL SENT');</script>";
						echo "<script type='text/javascript'> document.location = 'index.php'; </script>";
					}
