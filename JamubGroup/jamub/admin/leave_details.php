			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
                        ...
                        <div class="row">
									<div class="col-sm-8">
										<h6 class="text-blue h6"><b>EFFORTS MADE TO RESOLVE THE CHALLENGES</b></h6>
									</div>
									</div>
									<div class="form-group">
										<label>(Listed here are some of the actions taken to resolve the issues highlighted above.)</label>
										<textarea id="taskchallenges" name="taskchallenges" type="text" class="form-control" readonly autocomplete="off" placeholder=""><?php echo htmlentities($result->Challenges_Solution);?></textarea>
									</div>
                        <hr> 

                          <div class="row">
									<div class="col-sm-8">
										<h6 class="text-blue h6"><b>MY RECOMMENDATION(s)</b></h6>
									</div>
									</div>
									<div class="form-group">
										<label>(My views.)</label>
										<textarea id="taskchallenges" name="taskchallenges" type="text" class="form-control" readonly autocomplete="off" placeholder=""><?php echo htmlentities($result->Challenges_Recommendation);?></textarea> 
									</div>
							</div>
					...
					<?php 
						...
						?>  
							...
							<div class="card-box mb-30">
									...
									<div class="row">
										<div class="col-sm-8">
										<h6 class="text-blue h6"><b>HEAD's APPROVAL COMMENT</b></h6>
										</div>
									</div>
									<div class="form-group">
						...
						<div class="form-group row">
							<div class="col-md-6 col-sm-12">
							    <div class="form-group">
									<label style="font-size:16px;"><b>HEAD's Approval</b></label>
									<?php
									if ($result->HodSign==""): ?>
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>HRM's/Admin's Approval</b></label>
									<?php
									if ($result->RegSign==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
						...
						<div class="form-group row">
							<div class="col-md-6 col-sm-12">
							    <div class="form-group">
									<label style="font-size:16px;"><b>Date For HEAD's Action</b></label>
									<?php
									if ($result->HodDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Date For HRM's/Admin's Approval</b></label>
									<?php
									if ($result->RegDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Leave Status From HEAD</b></label>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Leave Status From HRM's/Admin's Approval</b></label>
