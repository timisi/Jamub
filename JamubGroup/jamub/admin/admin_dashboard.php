					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Total Partners</div>
							</div>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<td><?php echo $row['EvaluationType']; ?></td>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="approved_leave.php?leaveid=<?php echo $row['lid']; ?>"><i class="dw dw-eye"></i> View</a>
