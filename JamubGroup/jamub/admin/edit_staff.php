...
<?php
	...
	$result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', role='$user_role', Phonenumber='$phonenumber', Position_Staff='$position_staff', Staff_ID='$staff_id', Subsidiary='$subsidiary', Line_Manager='$linemanager', Supervisor='$supervisor', Grade='$gradelevel', Responsibilities='$responsibilities'   where emp_id='$get_id'         
		"); 		
	if ($result) {
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Parner's Portal</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Partner's Edit</li>
								</ol>
							</nav>
						</div>
					</div>
							...
							<section>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="gradelevel" type="text" class="form-control wizard-required" required="true" autocomplete="off" value="<?php echo $row['Grade']; ?>">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="linemanager" type="text" class="form-control" required="true" autocomplete="off" value="<?php echo $row['Line_Manager']; ?>">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Supervisor's Name :</label>
											<input name="supervisorname" type="text" class="form-control" required="true" autocomplete="off" value="<?php echo $row['Supervisor']; ?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="form-group">
											...
											<textarea id="" name="responsibilities" type="text"  class="form-control" required="true" autocomplete="off" placeholder="Enter partner's responsilities here&hellip;">
								...
								<div class="col-md-4 col-sm-12">
										...
										<label>Subsidiary :</label>
											<select name="subsidiary" class="custom-select form-control" required="true" autocomplete="off">
												<option value="<?php echo $new_row['Subsidiary']; ?>"><?php echo $new_row['Subsidiary']; ?></option>
                                                <option value="Jamubgroup">Jamub Group</option>
												<option value="JamubGlobal">Jamub Global</option>
												<option value="JamubConstruction">Jamub Contruction</option>
												<option value="JamubProperty">Jamub Property</option>
												<option value="Espermoh">Espermoh</option>
												<option value="JohnPaulPharmaceutical">John Paul Pharmaceutical</option>
												<option value="JamubEnergy">Jamub Energy</option>
												<option value="JamubITLounge">Jamub IT Lounge</option>
												<option value="MenzorLimited">Menzor Limited</option>
												<option value="PunditAgroLimited">Pundit Agro Limited</option>
												<option value="SchoolMeInvestment">SchoolMe Investment</option>
												<option value="uppisl">Urban Project Prospect Integrated Services Ltd (UPPISL)</option>
												<option value="JamubAcademy">Jamub Academy</option>
												<option value="Castravangaza">Castravangaza</option>
												<option value="StagebyStage">Stage by Stage</option>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="user_role" class="custom-select form-control" required="true" autocomplete="off">
												...
												<option value="HOD">Head/Lead</option>
