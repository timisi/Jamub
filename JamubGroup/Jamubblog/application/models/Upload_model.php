...
class Upload_model extends CI_Model
{
    ...
    //video image upload
    public function video_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'thumbnail_750x422_' . uniqid();
            $this->my_upload->image_convert = 'jpg';
            $this->my_upload->jpeg_quality = 70;
            $this->my_upload->image_ratio_crop = true;
            $this->my_upload->image_resize = true;
    ...
    //audio image upload
    public function audio_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'image_400x400_' . uniqid();
            $this->my_upload->image_convert = 'jpg';
            $this->my_upload->jpeg_quality = 70;
            $this->my_upload->image_ratio_crop = true;
            $this->my_upload->image_resize = true;
