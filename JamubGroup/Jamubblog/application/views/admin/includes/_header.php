                ...
                <?php if (is_admin()): ?>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>admin_video/add_video">
                                    <i class="fa fa-circle-o"></i> <?php echo trans("add_video"); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>audio/add_audio"> <i class="fa fa-circle-o"></i> <?php echo trans("add_audio"); ?></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>admin_post/featured_posts"><i class="fa fa-circle-o"></i> <?php echo trans("featured_posts"); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>admin_post/breaking_news"><i class="fa fa-circle-o"></i> <?php echo trans("breaking_news"); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>admin_post/recommended_posts"><i class="fa fa-circle-o"></i> <?php echo trans("recommended_posts"); ?></a>
                            </li>
                            <li>
