                    ...
                    <div class="form-group m0">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <button type="button" id="video_upload_button" onclick="upload_video('<?php echo $post->id; ?>');" class="btn btn-sm bg-olive m-l-5"><?php echo trans('upload'); ?></button>

                                <a class='btn btn-danger btn-sm m-l-5 delete-file-image-button' id="btn_delete_file_video" onclick="delete_video('<?php echo $post->id; ?>');"><?php echo trans('delete'); ?></a>
                ...
                <div class="tab-pane" id="tab_2">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-embed"
                                  name="video_embed_code" id="video_embed_code" placeholder="<?php echo trans('video_embed_code'); ?>"><?php echo $post->video_embed_code; ?></textarea>
                    </div>
