<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group m0">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <button type="button" id="post_image_upload_button" onclick="upload_post_image('<?php echo $post->id; ?>');" class="btn btn-sm bg-olive m-l-5"><?php echo trans('upload'); ?></button>
        ...
        <div class="form-group m0">
            <div class="row">
                <div class="col-sm-12">
                    <img src="<?php echo base_url() . $post->image_mid; ?>" id="img_video_thumbnail" class="img-responsive" alt="">
                </div>
            </div>
        </div>
