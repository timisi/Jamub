<div class="row table-filter-container">
    <div class="col-sm-12">
        ...
        <div class="item-table-filter">
            ...
            <select name="category" class="form-control" onchange="get_sub_categories(this.value);">
                <option value=""><?php echo trans("all"); ?></option>
        ...
        <div class="item-table-filter">
            ...
            <input name="q" class="form-control" placeholder="Search" type="search" value="<?php echo html_escape($this->input->get('q', true)); ?>">
        </div>

        <div class="item-table-filter" style="width: 65px; min-width: 65px;">
