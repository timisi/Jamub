                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="registration_system" value="1" id="registration_system_1"
                                   class="square-purple" <?php echo ($settings->registration_system == 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="comment_system" value="1" id="comment_system_1"
                                   class="square-purple" <?php echo ($settings->comment_system == 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="facebook_comment_active" value="1" id="facebook_comment_active_1"
                                   class="square-purple" <?php echo ($settings->facebook_comment_active == 1) ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            ...
                            <label for="show_rss_1" class="cursor-pointer" <?php echo ($settings->show_rss == "1") ? 'checked' : ''; ?>><?php echo trans('enable'); ?></label>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" id="show_rss_2" name="show_rss" value="0" class="square-purple" <?php echo ($settings->show_rss != "1") ? 'checked' : ''; ?>>&nbsp;&nbsp;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="show_featured_section" value="1" id="show_featured_section_1"
                                   class="square-purple" <?php echo ($settings->show_featured_section == 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="show_latest_posts" value="1" id="show_latest_posts_1"
                                   class="square-purple" <?php echo ($settings->show_latest_posts == 1) ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            ...
                            <label for="show_newsticker_1" class="cursor-pointer" <?php echo ($settings->show_newsticker == "1") ? 'checked' : ''; ?>><?php echo trans('yes'); ?></label>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" id="show_newsticker_2" name="show_newsticker" value="0" class="square-purple" <?php echo ($settings->show_newsticker == "0" || $settings->show_newsticker == null) ? 'checked' : ''; ?>>&nbsp;&nbsp;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="show_post_author" value="1" id="show_post_author_1"
                                   class="square-purple" <?php echo ($settings->show_post_author == 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="show_post_date" value="1" id="show_post_date_1"
                                   class="square-purple" <?php echo ($settings->show_post_date == 1) ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            ...
                            <label for="show_hits_1" class="cursor-pointer" <?php echo ($settings->show_hits == "1") ? 'checked' : ''; ?>><?php echo trans('yes'); ?></label>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" id="show_hits_2" name="show_hits" value="0" class="square-purple" <?php echo ($settings->show_hits != "1") ? 'checked' : ''; ?>>&nbsp;&nbsp;
