                    ...
                    <div class="col-sm-12">
                        <div class="page-content font-text">
                            ...
                            <?php foreach ($categories as $category): ?>
                                <div class="rss-item">
                                    <div class="left">
                                        <a href="<?php echo base_url(); ?>rss/category/<?php echo html_escape($category->name_slug); ?>" target="_blank"><i class="fa fa-rss"></i>&nbsp;&nbsp;<?php echo html_escape($category->name); ?></a>
                                    </div>
                                    <div class="right">
                                        <p><?php echo base_url(); ?>rss/category/<?php echo html_escape($category->name_slug); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
