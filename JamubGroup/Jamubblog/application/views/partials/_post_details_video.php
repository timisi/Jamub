...
<div class="show-on-page-load">
    ...
    <?php elseif (!empty($post->video_path)): ?>
        ...
        <div class="video-player">
            <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="750" height="422" poster="<?php echo base_url() . $post->image_default; ?>" data-setup="{}">
