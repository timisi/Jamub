<div class="box">
    ...
    <div class="box-body">
            ...
            <div class="row">
                <div class="col-sm-12 m-b-10">
                    <a class='btn btn-sm bg-purple'>
                        ...
                        <input type="file" id="input_audio_file" name="audio_file" class="uploadFile" accept=".mp3, .wav"
                               onchange="$('#input_audio_file_label').html($(this).val()); $('#input_audio_file_button').show();">
                    </a>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <button type="button" id="audio_upload_button" onclick="upload_audio('<?php echo $post->id; ?>');" class="btn btn-md bg-olive pull-right"><?php echo trans('upload'); ?></button>
                </div>
            </div>
        </div>
                        ...
                        <?php if (!empty($audios)): ?>
                            <?php foreach ($audios as $audio): ?>
                                <p class="play-list-item">
                                    ...
                                    <a href="javascript:void(0)" onclick="delete_audio('<?php echo $audio->id; ?>');" class="btn btn-xs btn-danger pull-right"><?php echo trans('delete'); ?></a>
                                </p>
                            <?php endforeach; ?>
                        <?php else: ?>
