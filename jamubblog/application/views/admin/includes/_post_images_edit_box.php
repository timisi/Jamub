<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group m0">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <button type="button" onclick="upload_post_additional_image('<?php echo $post->id; ?>');" class="btn btn-sm bg-olive m-l-5"><?php echo trans('upload'); ?></button>
        ...
        <div class="form-group m0">
            <?php $additional_images = get_post_images($post->id); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12 m-b-15">
                            <div class="additional-image-list">
                                ...
                                <a class='btn btn-danger btn-sm m-l-5 delete-additional-image-button' id="btn_delete_file_image" onclick="delete_post_additional_image('<?php echo $image->id; ?>');"><i class="fa fa-times"></i> </a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
