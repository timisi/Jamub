            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="keywords"
                           placeholder="<?php echo trans('keywords'); ?> (<?php echo trans('meta_tag'); ?>)" value="<?php echo html_escape($page->keywords); ?>">
                </div>

                <?php if ($page->location == "main"): ?>
                    <div class="form-group">
                        <label class="control-label"><?php echo trans('parent_link'); ?></label>
                        <select name="parent_id" class="form-control" style="max-width: 600px;">
                ...
                <?php if ($page->slug != "register" && $page->slug != "login" && $page->slug != "reset-password" && $page->slug != "update-profile" && $page->slug != "change-password" && $page->slug != "posts" && $page->slug != "rss-channels" && $page->slug != "reading-list"): ?>
                    <div class="form-group">
                        <label><?php echo trans('order'); ?></label>
                        <input type="number" class="form-control" name="page_order" placeholder="<?php echo trans('order'); ?>"
                               value="<?php echo html_escape($page->page_order); ?>" min="0" max="99999"
                ...
                <?php if ($page->slug != "index" && $page->slug != "video" && $page->slug != "register" && $page->slug != "login" && $page->slug != "posts" && $page->slug != "reset-password" && $page->slug != "update-profile" && $page->slug != "change-password" && $page->slug != "rss-channels" && $page->slug != "reading-list"): ?>
                    <div class="form-group">
                        <div class="row">
