        ...
        <div class="post-item">
            <?php if (isset($show_label)): ?>
                ...
                <?php if (!empty($post_category['id'])):
                    ...
                    <?php else: ?>
                        <a href="<?php echo base_url(); ?>category/<?php echo html_escape($post_category['name_slug']); ?>">
                            <label class="category-label category-label-relative" style="background-color: <?php echo html_escape($post_category['color']); ?>"><?php echo html_escape($post_category['name']); ?></label>
                        </a>
                    <?php endif;
                endif; ?>
